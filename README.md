...
> Public release note: identifiers, exact coordinates, account details, phone numbers, vehicle registrations, and other sensitive fields should be redacted or anonymized before public upload.
